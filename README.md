...
</p>This project allows the barber to view the list of the appointments of a particular day. This project was developed using React with Context API and Hooks.</p>
